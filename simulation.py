...
if __name__ == "__main__":
    ...
    #samp = np.array([[0.00 ,  0.00 ,  0.0 ,  0.0],
    #                 [-157.05 ,  -2.55 ,  486.29 ,  -566.08],
    #                 [-247.32 ,  -94.98 ,  469.12 ,  -270.17],
    #                 [-288.42 ,  -136.85 ,  460.54 ,  21.32],
    #                 [76.96 ,  -179.92 ,  408.11 ,  -574.62],
    #                 [-232.91 ,  185.81 ,  398.12 ,  -574.50],
    #                 [-7.36 ,  -286.77 ,  391.38 ,  -276.58],
    #                 [-50.40 ,  -332.80 ,  385.12 ,  15.29],
    #                 [-337.29 ,  100.01 ,  385.01 ,  -283.22],
    #                 [-379.81 ,  56.47 ,  372.12 ,  11.51],
    #                 [300.26 ,  -327.85 ,  339.74 ,  -553.71],
    #                 [-294.37 ,  374.47 ,  320.03 ,  -553.47],
    #                 [206.02 ,  -452.63 ,  349.14 ,  -257.28],
    #                 [-39.56 ,  -6.12 ,  346.42 ,  -584.71],
    #                 [166.72 ,  -505.28 ,  345.64 ,  34.70],
    #                 [-412.84 ,  275.88 ,  327.04 ,  -262.77],
    #                 [-144.26 ,  -115.82 ,  362.45 ,  -293.03],
    #                 [-475.25 ,  221.49 ,  346.42 ,  19.61],
    #                 [160.03 ,  -174.23 ,  316.30 ,  -587.66],
    #                 [-129.90 ,  158.03 ,  300.27 ,  -587.75],
    #                 [68.70 ,  -282.22 ,  300.30 ,  -289.87],
    #                 [25.20 ,  -331.25 ,  293.92 ,  2.21],
    #                 [-229.82 ,  61.99 ,  290.45 ,  -296.41],
    #                 [-276.27 ,  17.02 ,  281.02 ,  -4.13],
    #                 [58.69 ,  -10.22 ,  238.01 ,  -584.83],
    #                 [-30.96 ,  -107.45 ,  215.68 ,  -290.86],
    #                 [-72.18 ,  -152.62 ,  209.11 ,  -1.01]])
    #Output Anchors were:
    #[[    0.         -2333.35996948   -75.5       ]
    # [-1996.5944233    846.06083386   -75.5       ]
    # [ 1457.76612629  1268.89566943   -75.5       ]
    # [    0.             0.          2688.40651694]]
    #Anchor errors were:
    #[[   0.         -170.35996948    0.        ]
    # [-155.5944233   105.06083386    0.        ]
    # [-181.23387371 -135.10433057    0.        ]
    # [   0.            0.         -562.09348306]]
    #cost: 5087.646592
    #samp = np.array([[0.00 ,  0.00 ,  0.0 , 0.0],
    #                 [-159.25 ,  -6.47 ,  459.82 ,  -537.31],
    #                 [-239.33 ,  -87.78 ,  430.39 ,  -240.75],
    #                 [-274.72 ,  -123.70 ,  423.96 ,  32.60],
    #                 [121.99 ,  -146.30 ,  309.68 ,  -576.69],
    #                 [-182.03 ,  235.18 ,  296.66 ,  -576.68],
    #                 [51.79 ,  -233.99 ,  257.86 ,  -278.52],
    #                 [21.02 ,  -272.97 ,  235.63 ,  10.21],
    #                 [-263.32 ,  163.13 ,  244.61 ,  -288.30],
    #                 [-299.19 ,  131.33 ,  215.42 ,  9.63],
    #                 [390.12 ,  -242.65 ,  170.56 ,  -563.80],
    #                 [-175.49 ,  466.33 ,  143.28 ,  -563.67],
    #                 [325.55 ,  -361.20 ,  141.19 ,  -267.25],
    #                 [82.36 ,  87.86 ,  140.01 ,  -597.38],
    #                 [295.45 ,  -403.52 ,  114.38 ,  19.11],
    #                 [-262.52 ,  389.03 ,  98.23 ,  -278.11],
    #                 [7.84 ,  -1.19 ,  94.54 ,  -308.42],
    #                 [-298.74 ,  351.80 ,  71.45 ,  10.20],
    #                 [347.85 ,  -19.96 ,  0.44 ,  -599.35],
    #                 [79.61 ,  310.34 ,  -29.79 ,  -599.32],
    #                 [278.63 ,  -123.97 ,  -56.14 ,  -300.86],
    #                 [245.79 ,  -159.29 ,  -91.99 ,  -3.15],
    #                 [-3.15 ,  234.79 ,  -92.25 ,  -301.69],
    #                 [-34.59 ,  201.51 ,  -127.64 ,  -3.54],
    #                 [347.49 ,  221.46 ,  -199.89 ,  -583.66],
    #                 [281.80 ,  149.80 ,  -282.62 ,  -287.03],
    #                 [253.20 ,  118.41 ,  -321.17 ,  9.78]])
    #Output Anchors were:
    #[[    0.         -2410.20127441   -75.5       ]
    # [-2014.90304946   907.80588509   -75.5       ]
    # [ 1465.60765438  1260.01869006   -75.5       ]
    # [    0.             0.          2596.95303505]]
    #Anchor errors were:
    #[[   0.         -247.20127441    0.        ]
    # [-173.90304946  166.80588509    0.        ]
    # [-173.39234562 -143.98130994    0.        ]
    # [   0.            0.         -653.54696495]]
